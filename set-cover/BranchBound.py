__author__ = "Andrea Rubbi & Daoud Ahmat Younous alis Kristos97"
import time
...
def main(a,b,c,z=time.time()):
    ...
    print('Size data:',len(c))
    print('time:',t)
    size_data.append(len(c))
    time_exec.append(t)
...
if __name__=='__main__':
    ...
    ax.plot(size_data, time_exec, label='Branch & Bound')  # Plot some data on the axes.
    ax.set_xlabel('Data size')  # Add an x-label to the axes.
    ax.set_ylabel('Time')  # Add a y-label to the axes.
    ax.set_title("Programmation Dynamique")  # Add a title to the axes.
